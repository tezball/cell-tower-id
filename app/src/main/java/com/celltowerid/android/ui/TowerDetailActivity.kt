...
import com.celltowerid.android.databinding.ActivityTowerDetailBinding
import com.celltowerid.android.databinding.ItemHistoryBinding
...
import com.celltowerid.android.ui.viewmodel.TowerDetailViewModel
import com.celltowerid.android.util.CellIdParser
import com.celltowerid.android.util.CellPropertyHelp
...
class TowerDetailActivity : AppCompatActivity() {
    ...
    private fun addRowWithQuality(
        ...
        label: String,
        value: String,
        quality: com.celltowerid.android.domain.model.SignalQuality,
        helpKey: CellPropertyHelp.Key? = null
    ) {
