...
class CollectionService : LifecycleService() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.celltowerid.android.ACTION_START_COLLECTION"
        const val ACTION_STOP = "com.celltowerid.android.ACTION_STOP_COLLECTION"
    ...
    private fun startLocationUpdates(intervalMs: Long) {
        ...
        try {
            ...
            updateNotification(getString(com.celltowerid.android.R.string.scanning_failed_text))
        } catch (e: Exception) {
    ...
    private fun postPermissionLostNotification() {
        ...
        val n = NotificationCompat.Builder(this, ALERT_CHANNEL_ID)
            .setContentTitle(getString(com.celltowerid.android.R.string.scanning_stopped_title))
            .setContentText(getString(com.celltowerid.android.R.string.scanning_stopped_text))
            .setSmallIcon(com.celltowerid.android.R.drawable.ic_notification_tower)
            .setContentIntent(pi)
            .setAutoCancel(true)
            .build()
        try {
